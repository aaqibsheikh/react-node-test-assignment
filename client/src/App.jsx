        ...
        {!loggedUser ? (
          <div className={`flex justify-center items-center w-full `}>
            <Routes>
              ...
              <Route
                exact
                path="/auth/forgot_password/enter_code"
                element={<InputCode />}
              />
              <Route
                exact
            ...
            >
              ...
              <div className="flex p-[1rem] w-full">
                <Routes>
                  ...
                  <Route
                    path="/leads/call-reminders"
                    element={<AllFollowUps />}
                  />
                  <Route
                    path="/leads/ledger"
                  ...
                  <Route
                    path="/voucher"
                    element={<Vouchers showSidebar={showSidebar} />}
                  />
